...
export const env = {
  ...
  transcriptCacheTtlSeconds: parseInteger(process.env.TRANSCRIPT_CACHE_TTL_SECONDS, 60 * 60 * 12),
  transcriptFailureCacheTtlSeconds: parseInteger(process.env.TRANSCRIPT_FAILURE_CACHE_TTL_SECONDS, 10 * 60),
  supadataRetryCount: parseInteger(process.env.SUPADATA_RETRY_COUNT, 1),
  supadataRetryBaseDelayMs: parseInteger(process.env.SUPADATA_RETRY_BASE_DELAY_MS, 800),
